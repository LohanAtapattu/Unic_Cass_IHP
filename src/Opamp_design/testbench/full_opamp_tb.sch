...
C {vsource.sym} -590 220 0 0 {name=V4 value="DC 0.6 AC -0.1m" savecurrent=false}
C {vsource.sym} -350 220 0 0 {name=V5 value="DC 0.6 AC 0.1m" savecurrent=false}
...
C {vsource.sym} -70 50 0 0 {name=V1 value=0.6 savecurrent=false}
C {gnd.sym} -70 140 0 0 {name=l6 lab=GND}
C {vsource.sym} -80 260 0 0 {name=V2 value=1.2 savecurrent=false}
...
C {vsource.sym} 140 310 0 0 {name=V8 value=1.2 savecurrent=false}
C {gnd.sym} 70 370 0 0 {name=l11 lab=GND}
C {vsource.sym} 70 290 0 0 {name=V9 value=0 savecurrent=false}
...
C {isource.sym} -180 220 0 0 {name=I0 value=4u}
C {gnd.sym} -180 300 0 0 {name=l13 lab=GND}
