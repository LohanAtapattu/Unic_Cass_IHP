...
C {vsource.sym} 110 -430 0 0 {name=V5 value=1.8 savecurrent=false}
C {vsource.sym} 130 -200 0 0 {name=V2 value=0.9 savecurrent=false}
C {vsource.sym} 70 -170 0 0 {name=V1 value=1.8 savecurrent=false}
...
C {vsource.sym} -760 -270 0 0 {name=V11 value=0.9 savecurrent=false}
...
C {vsource.sym} -480 -270 0 0 {name=V7 value=1.6 savecurrent=false}
