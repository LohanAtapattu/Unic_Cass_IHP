...
N 150 -490 150 -460 {lab=vdd}
N 150 -490 210 -490 {lab=vdd}
N 210 -490 210 -460 {lab=vdd}
N 210 -460 270 -460 {lab=vdd}
C {Unic_cass_final_design_lvs/Simulations/Opamp_design/Src/common_source_stage.sym} -10 -40 0 0 {name=x1}
C {Unic_cass_final_design_lvs/Simulations/Opamp_design/Src/Folded_cascode.sym} -150 -40 0 0 {name=x2}
...
C {Unic_cass_final_design_lvs/Simulations/Opamp_design/Src/Bias_circuit.sym} -870 -230 0 0 {name=x3}
...
C {title.sym} -950 410 0 0 {name=l8 author="EpitaXC"}
...
C {lab_pin.sym} 270 -460 1 0 {name=p23 sig_type=std_logic lab=vdd}
C {sg13g2_pr/cap_cmim.sym} 180 -460 1 0 {name=C4
model=cap_cmim
w=10.0e-6
l=2.0e-6
m=20
